...
<div class="content mt-5 container">
    ...
    <div class="col-12 col-md-6 order-input-group mt-3">
        <label for="">Your fullname <strong class="text-danger">*</strong></label>
        <input type="text" class="order-input"  id="fullname" required>
    </div>
    <div class="col-12"></div>
    <div class="col-12 col-md-6 order-input-group mt-3">
        <label for="">Your email <strong class="text-danger">*</strong></label>
        <input type="text" class="order-input"  id="email" required>
    </div>
    <div class="col-12"></div>
    <div class="col-12 col-md-6 order-input-group zipcode-ebject mt-3">
        <label for="">Enter zipcode<strong class="text-danger">*</strong></label>
        <input type="text" id="zipcode" onkeyup="loadZipcode(this.value)" required>
...
<div class="row justify-content-center  mt-5">
    <div class="col-md-4 text-center sm-d-none">
        <div class="border-gold">
            <div class="price-card {{$price == '119' ? 'active' : ''}} start" data-price="119">
    ...
    <div class="col-md-4 text-center sm-d-none">
        <div class="border-gold">
            <div class="price-card {{$price == '189' ? 'active' : ''}} medium" data-price="189">
    ...
    <div class="col-md-4 text-center sm-d-none">
        <div class="border-gold">
            <div class="price-card {{$price == '239' ? 'active' : ''}} advanced" data-price="239">
        ...
        <div class="col-12 sm-d-block">
            <h4 class="text-white text-center">Pricing</h4>
        </div>
        <div class="sm-d-block col-4 p-1">
            <div class="pricing-card-select {{$price == '119' ? 'active' : ''}}" data-price="119">
                <h6>$ 119.00</h6>
                <small>60 min</small>
            </div>
        </div>
        <div class="sm-d-block col-4 p-1">
            <div class="pricing-card-select {{$price == '189' ? 'active' : ''}}" data-price="189">
                <h6>$ 189.00</h6>
                <small>90 min</small> 
            </div>
        </div>
        <div class="sm-d-block col-4 p-1">
            <div class="pricing-card-select {{$price == '239' ? 'active' : ''}}" data-price="239">
                <h6>$ 239.00</h6>
                <small>120 min</small> 
            </div>
        </div>
    ...
    @else
        ...
        <div class="row justify-content-center ">
            <div class="col-12 col-md-6">
                    <h1 class="text-center checkout-price">${{$order->price}}.00</h1>
                    <h3 class="text-center book-service">Scan the qr code to transfer money and attach the bill.</h3>
            </div>
        </div>

         <form id="upload_bill" class="row pt-5  justify-content-center" >
             @csrf
             @method('PUT')
                
                <div class="col-12 col-md-7 order-input-group mb-3">
                    <label for="">Your phone <strong class="text-danger">*</strong></label>
                    <input type="text" class="order-input" name="phone" required>
                </div>
                <div class="col-12 col-md-7 order-input-group mb-3">
                    <label for="">Your address <strong class="text-danger">*</strong></label>
                    <textarea type="text" class="order-input" name="address" rows="3" required></textarea>
                </div>
                <div class="col-12"></div>
                ...
                <div class="your-order">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-7" style="font-size: 14px;">
                            ...
                            {{-- <div><p>Fullname</p> : {{$order->fullname}}</div>
                    ...
                    {{-- 
                     ...
                     <div class="row mt-5" style="font-size: 14px">
                        <div class="col-8 text-center">
                            <div class="policy-group">
                                <input type="text" class="policy-input" name="signature" value="{{$policy->signature}}"  readonly>
                                <input type="hidden" value="{{$order->id}}" name="order_id">
                                <label for="">Clienr Signature</label>
                            </div>
                          </div>
                          <div class="col-4 text-center">
                            <div class="policy-group">
                                <input type="text" class="policy-input" name="date" value="{{$policy->date}}" readonly>
                                <label for="">Date</label>
                            </div>
                          </div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function nextStep(){
            ...
            var email = $('#email').val()
            if(zipcode == "" || style == "" || price == "" || fullname == "" || email == ""){
                swal('Warning !!' , 'Please fill out the information completely. ' , 'warning')
                return false
            }
            $.post(`{{url('order')}}` , {zipcode:zipcode , price:price , style:style , fullname:fullname , email:email , _token:token} , function(data){
                if(data.success){
                    $('#policyModal input[name=order_id]').val(data.order_id)
                    $('#policyModal').modal("show")
                }else{
                    swal('Alert' , ' '+data.msg , 'error')
                }
        ...
        $('.pricing-card-select').on('click' , function(){
            $('.pricing-card-select').removeClass('active')
            $(this).addClass('active')
            var price = $(this).data('price')
            $('#price').val(price)
        })
